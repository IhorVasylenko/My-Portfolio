        ...
        <div className={style.main}>
            <div className={style.content}>
                <div className={style.container}>
                    ...
                    <AnimationForButton >
                        <Link to='https://github.com/IhorVasylenko/My-Portfolio/blob/9dda45994c245ef2c7c4c58f79866a9338ecccec/public/files/Front-End_CV.pdf' target="_blank" download className={style.link}>
                            Download CV
                        </Link>
                    </AnimationForButton>
                    {
